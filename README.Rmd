...
This repository contain the R package to easily work with the `posteriordb` repository. The R package included database contain convenience functions to access data, model code and information for individual posteriors, models, data and draws.
